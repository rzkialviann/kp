  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-sm bg-white dark:bg-[#18181b] border border-slate-200 dark:border-slate-800 shadow-2xl p-8">
        ...
        <div className="mb-8">
          <h3 className="text-xl font-medium tracking-tight text-slate-800 dark:text-slate-300 mb-2">{title}</h3>
        ...
        <div className="flex justify-end gap-6 pt-4 border-t border-slate-200 dark:border-slate-800">
          <button onClick={onClose} className="text-[10px] font-bold uppercase tracking-widest text-slate-400 hover:text-slate-800 dark:hover:text-slate-200 transition-colors">
            Batalkan
          </button>
