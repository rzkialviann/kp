      ...
      <div className="w-full px-6 lg:px-12 xl:px-20 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 reveal">
          <div className="lg:col-span-4">
            ...
            <h3 className="text-3xl font-medium tracking-tight text-slate-800 dark:text-slate-300 max-w-sm">
              ...
              {certs.map(c => (
                <div key={c.code} className="grid grid-cols-1 sm:grid-cols-12 gap-4 py-8 border-b border-slate-200 dark:border-slate-800 hover:bg-zinc-50 dark:hover:bg-slate-800/30 transition-colors">
                  <div className="sm:col-span-3">
                    <h4 className="text-2xl font-light tracking-tight text-slate-800 dark:text-slate-300">{c.code}</h4>
                  </div>
                  <div className="sm:col-span-4">
                    <p className="text-xs font-bold uppercase tracking-widest text-slate-800 dark:text-slate-300 mb-2">{c.label}</p>
                  </div>
